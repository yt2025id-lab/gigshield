  ...
  <nav className="fixed top-0 w-full z-50 bg-dark-950/80 backdrop-blur-xl border-b border-gray-800">
    <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8">
        <Link href="/?tab=pools" className="text-gray-400 hover:text-white transition-colors">Pools</Link>
        <Link href="/?tab=claims" className="text-gray-400 hover:text-white transition-colors">Claims</Link>
        <Link href="/?tab=validate" className="text-gray-400 hover:text-white transition-colors">Validate</Link>
